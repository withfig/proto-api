...
struct Fig_ClientOriginatedMessage {
  ...
  var ptyRequest: Fig_PseudoterminalRequest {
    get {
      if case .ptyRequest(let v)? = submessage {return v}
      return Fig_PseudoterminalRequest()
    }
  ...
  enum OneOf_Submessage: Equatable {
    ...
    case ptyRequest(Fig_PseudoterminalRequest)
...
struct Fig_PseudoterminalRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Fig_ClientOriginatedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    200: .standard(proto: "position_window_request"),
    300: .standard(proto: "pty_request"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 300: try {
        var v: Fig_PseudoterminalRequest?
        var hadOneofValue = false
        if let current = self.submessage {
          hadOneofValue = true
...
extension Fig_PseudoterminalRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PseudoterminalRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Fig_PseudoterminalRequest, rhs: Fig_PseudoterminalRequest) -> Bool {
